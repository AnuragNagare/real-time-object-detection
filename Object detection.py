...
while True:
    ...
    for i in indices:
        ...
        # Speak the detected object information
        object_info = f"Label: {label}, Confidence: {confidence:.2f}, Height: {h} pixels"
        ...
        cv2.putText(frame, f'Height: {h} pixels', (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
...
for obj in detected_objects:
    print(f"Label: {obj['label']}, Confidence: {obj['confidence']:.2f}, Height: {obj['height']} pixels")
